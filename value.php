...
return ' '.$jam.' 😜 Like And CommeNT done plz Like Back ║ facebook.com/profile.php ║Bot powered by Sattarbd║follow bot developer ║facebook.com/sattartips'.$nae.'
 '.$hr;
}
...
CURLOPT_USERAGENT => 'DESCRIPTION by www.amar.ml',
));
$ch=curl_exec($cx);
curl_close($cx);
return ($ch);
